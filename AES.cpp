...
bool AES::setKey(const unsigned char* keyArray)
{
	...
	//unsigned char* keyCopy = new unsigned char[16];
	
	// ADD: Use twoCHarTOPHex function to conver thre 32 byte key into a 16 byte key
	/* The key error code */
	int keyErrorCode = -1;
	...
	for (int i = 0; i < 16; i++)
		fprintf(stdout, "%x", this->aes_key[i]);

	AES_set_encrypt_key(keyArray, 128, &this->enc_key);
	AES_set_decrypt_key(keyArray, 128, &this->dec_key);
